...
def main(args=None):
    ...
    for idx, item in enumerate(os.listdir(args.model_path)):
        ...
        models.append(compute_batch.load_extractor(device,model_path,args.model_type))
    ...
    for idx in range(10):
        ...
        for _ in range(args.attain_model_num):
            model_idx = random.randint(0, model_num-1)    
            extractor = models[model_idx]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--attain_model_num', type=int, default=2, help='attain models number')
